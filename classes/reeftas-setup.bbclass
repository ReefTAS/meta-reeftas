...
REEFTAS_ROOTFS_PART_A_DEFAULT = "${REEFTAS_STORAGE_DEVICE_BASE}1"
REEFTAS_ROOTFS_PART_B ??= "${REEFTAS_ROOTFS_PART_B_DEFAULT"
REEFTAS_ROOTFS_PART_B_DEFAULT = "${REEFTAS_STORAGE_DEVICE_BASE}2"

#Var partition
REEFTAS_VAR_PART ??= "${REEFTAS_VAR_PART_DEFAULT}"
REEFTAS_VAR_PART_DEFAULT = "${REEFTAS_STORAGE_DEVICE_BASE}3"
